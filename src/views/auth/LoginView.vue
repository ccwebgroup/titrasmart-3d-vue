            ...
            <div class="grid gap-2">
                ...
                <div class="relative">
                    ...
                    <input v-model="password" id="password" type="password"
                        class="h-10 w-full rounded-md border border-white/10 bg-white/5 pl-10 pr-4 text-sm text-white focus:border-blue-500/50 focus:outline-none focus:ring-1 focus:ring-blue-500/50 transition-colors"
                        required />
                </div>
            </div>

            <button type="submit" :disabled="isLoading"
                class="inline-flex h-10 w-full items-center justify-center rounded-md bg-blue-600 px-4 text-sm font-semibold text-white transition-all hover:bg-blue-500 hover:shadow-lg hover:shadow-blue-500/20 active:scale-[0.98] disabled:opacity-50">
